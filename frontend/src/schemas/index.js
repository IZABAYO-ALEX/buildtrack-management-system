...
export const projectSchema = z.object({
  ...
  budget: z.coerce().positive('Budget must be greater than 0').min(1, 'Budget must be at least 1'),
...
export const expenseSchema = z.object({
  ...
  amount: z.coerce.number().positive('Amount must be greater than 0').min(1, 'Amount must be at least 1'),
...
export const workerSchema = z.object({
  ...
  rate: z.coerce.number().positive('Rate must be greater than 0').min(1, 'Rate must be at least 1'),
  projectId: z.string().uuid('Please select a project'),
